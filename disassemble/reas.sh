...
reas cmpromwhite/builtin        cmpromwhite_builtin.bin     cmpromwhite_builtin_ref.s   0x0     cmpromwhite_builtin.sym
reas cmpromwhite/v160           cmpromwhite_v160.bin        cmpromwhite_v160_ref.s      0x3200  cmpromwhite_v160.sym
